      ...
      <div className="flex flex-col items-center space-y-4">
        <div className="relative w-32 h-32 flex items-center justify-center">
          ...
          <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
            <div
              className={`animate-ripple-1 absolute w-20 h-20 border-2 opacity-60 rounded-full`}
              style={{ borderColor: color }}
            ></div>
            <div
              className={`animate-ripple-2 absolute w-20 h-20 border-2 opacity-80 rounded-full`}
              style={{ borderColor: color }}
            ></div>
            <div
              className={`animate-ripple-3 absolute w-20 h-20 border-2 rounded-full`}
              style={{ borderColor: color }}
            ></div>
          </div>
        </div>
